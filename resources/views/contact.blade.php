            ...
            <section class="relative overflow-hidden">
                ...
                <div class="mx-auto max-w-2xl px-6 pt-16 pb-4 text-center lg:px-8 lg:pt-20">
                    ...
                    <p class="mt-6 text-lg leading-relaxed text-zinc-600 text-pretty dark:text-zinc-400">
                        {{ __('Have a question about an article, a correction to suggest, or feedback on :site? We would like to hear from you.', ['site' => $siteName]) }}
                    </p>
                </div>
            </section>
            ...
            <section class="mx-auto max-w-3xl px-6 py-14 lg:px-8">
                <div class="grid gap-6 sm:grid-cols-2">
                    <div class="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
                        ...
                        <h2 class="mt-4 font-semibold text-zinc-900 dark:text-white">{{ __('General Inquiries') }}</h2>
                    ...
                    <div class="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
                        ...
                        <h2 class="mt-4 font-semibold text-zinc-900 dark:text-white">{{ __('Editorial & Corrections') }}</h2>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                ...
                <div class="mt-10 rounded-2xl border border-zinc-200 bg-zinc-50 p-6 text-sm leading-relaxed text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/40 dark:text-zinc-400">
                    <p>
                        {{ __('We aim to respond to every message within a few business days. :site publishes educational and informational content only; we are not able to provide personalized financial, investment, tax, or legal advice through this contact channel.', ['site' => $siteName]) }}
                    </p>
                </div>
            </section>
        </main>
