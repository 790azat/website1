        ...
        <main>
            ...
            <section class="border-t border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/40">
                <div class="mx-auto max-w-3xl px-6 py-14 text-center lg:px-8">
                    <h2 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ __('Our Mission') }}</h2>
                    <p class="mt-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{ __('Our mission is to provide accessible, practical information that helps readers better understand financial, business, and organizational topics. We focus on clarity, transparency, and useful insights that can be applied to real-world situations.') }}
                    </p>
                </div>
            </section>
            ...
            <section class="mx-auto max-w-6xl px-6 py-16 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <h2 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ __('What We Do') }}</h2>
                    <p class="mt-3 leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{ __('We research and publish educational resources covering a range of topics, including:') }}
                    </p>
                </div>
                ...
                <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($services as $service)
                        <div class="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
                            ...
                            <h3 class="mt-4 font-semibold text-zinc-900 dark:text-white">{{ __($service['title']) }}</h3>
                            <p class="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">{{ __($service['description']) }}</p>
                        </div>
                    @endforeach
                </div>
            </section>
            ...
            <section class="border-t border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/40">
                <div class="mx-auto max-w-3xl px-6 py-14 lg:px-8">
                    <h2 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ __('Our Approach') }}</h2>
                    <p class="mt-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{ __('We believe information should be clear, transparent, and easy to evaluate. Our content is based on publicly available information, research, established concepts, and practical business knowledge.') }}
                    </p>
                    <p class="mt-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{ __('We aim to explain complex subjects without unnecessary jargon or misleading claims. Where appropriate, our articles discuss different factors, potential benefits, challenges, and considerations so readers can develop a better understanding of the subject.') }}
                    </p>
                    <p class="mt-4 rounded-xl border border-zinc-200 bg-white p-4 text-sm leading-relaxed text-zinc-500 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-500">
                        {{ __('Our content is intended for educational and informational purposes and should not be considered personalized financial, investment, tax, legal, or professional advice.') }}
                    </p>
                </div>
            </section>
            ...
            <section id="team" class="mx-auto max-w-6xl scroll-mt-24 px-6 py-16 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <h2 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ __('Our Editorial Team') }}</h2>
                    <p class="mt-3 leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{ __('Our team brings together professionals with experience across financial research, investment strategy, data analysis, business technology, and organizational strategy. Their combined expertise supports the range of topics covered throughout :site.', ['site' => $siteName]) }}
                    </p>
                </div>
                ...
                <div class="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($team as $member)
                        <div class="text-center">
                            ...
                            <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ __($member['role']) }}</p>
                            <p class="mt-3 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">{{ __($member['bio'], ['site' => $siteName]) }}</p>
                        </div>
                    @endforeach
                </div>
            </section>
            ...
            <section class="border-t border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/40">
                <div class="mx-auto max-w-3xl px-6 py-14 lg:px-8">
                    <h2 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ __('Our Editorial Focus') }}</h2>
                    <p class="mt-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{ __('The expertise of our contributors allows :site to cover topics from multiple professional perspectives. Financial topics are examined alongside developments in business strategy, technology, data, and organizational leadership.', ['site' => $siteName]) }}
                    </p>
                    <p class="mt-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{ __('This multidisciplinary approach helps us present information in context rather than treating individual financial or business decisions in isolation.') }}
                    </p>
                    <p class="mt-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
                        {{ __('We also aim to keep our content practical. Articles focus on explaining concepts, identifying important considerations, and helping readers understand how different strategies and developments can affect businesses, professionals, and consumers.') }}
                    </p>
                </div>
            </section>
            ...
            <section class="mx-auto max-w-5xl px-6 py-16 text-center lg:px-8">
                <div class="rounded-3xl bg-zinc-900 px-8 py-14 dark:bg-white">
                    <h2 class="text-2xl font-semibold tracking-tight text-white sm:text-3xl dark:text-zinc-900">
                        {{ __('Thank You for Visiting :site', ['site' => $siteName]) }}
                    </h2>
                    <p class="mx-auto mt-4 max-w-2xl leading-relaxed text-zinc-300 dark:text-zinc-600">
                        {{ __('We are committed to providing useful, transparent, and research-driven information that helps readers better understand financial, business, technology, and organizational topics. We will continue developing educational resources designed to make complex subjects easier to understand and evaluate.') }}
                    </p>
