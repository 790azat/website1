...
return [
    ...
    'authors' => [
        'emily-carter' => [
            ...
            'photo' => 'emily-carter.webp',
        ],
        'james-mitchell' => [
            'name' => 'James Mitchell',
            'role' => 'Financial Specialist',
            'photo' => 'james-mitchell.webp',
        ],
        'michael-anderson' => [
            'name' => 'Michael Anderson',
            'role' => 'Business and Data Analyst',
            'photo' => 'michael-anderson.webp',
        ],
        'daniel-brooks' => [
            'name' => 'Daniel Brooks',
            'role' => 'Financial Specialist',
            'photo' => 'daniel-brooks.webp',
        ],
    ],
    ...
    'programs' => [
        [
            ...
            'cta_url' => 'https://website2-790azat.vercel.app/',
            'hero_icon' => 'megaphone',
            'hero_gradient' => 'bg-gradient-to-br from-orange-500 to-amber-600',
            'hero_image' => 'programs/ama-digital-marketing-certification.webp',
        ...
        [
            ...
            'hero_image' => 'programs/lsu-online-mba-in-marketing.webp',
